...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.UTCDateTime = QtWidgets.QGroupBox(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.UTCDateTime.setFont(font)
        self.UTCDateTime.setObjectName("UTCDateTime")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.UTCDateTime)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.txt_utcdate = QtWidgets.QLabel(self.UTCDateTime)
        font = QtGui.QFont()
        font.setFamily("Digital-7")
        font.setPointSize(30)
        self.txt_utcdate.setFont(font)
        self.txt_utcdate.setAlignment(QtCore.Qt.AlignCenter)
        self.txt_utcdate.setObjectName("txt_utcdate")
        self.gridLayout_5.addWidget(self.txt_utcdate, 0, 0, 1, 1)
        self.txt_utc = QtWidgets.QLabel(self.UTCDateTime)
        font = QtGui.QFont()
        font.setFamily("Digital-7")
        font.setPointSize(30)
        ...
        self.gridLayout_5.addWidget(self.txt_utc, 2, 0, 1, 1)
        self.gridLayout.addWidget(self.UTCDateTime, 1, 0, 1, 1)
        self.LocalDateTime = QtWidgets.QGroupBox(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.LocalDateTime.setFont(font)
        self.LocalDateTime.setObjectName("LocalDateTime")
        self.gridLayout_51 = QtWidgets.QGridLayout(self.LocalDateTime)
        self.gridLayout_51.setObjectName("gridLayout_51")
        self.txt_localdate = QtWidgets.QLabel(self.LocalDateTime)
        font = QtGui.QFont()
        font.setFamily("Digital-7")
        font.setPointSize(30)
        self.txt_localdate.setFont(font)
        self.txt_localdate.setAlignment(QtCore.Qt.AlignCenter)
        self.txt_localdate.setObjectName("txt_localdate")
        self.gridLayout_51.addWidget(self.txt_localdate, 0, 0, 1, 1)
        self.txt_localtime = QtWidgets.QLabel(self.LocalDateTime)
        font = QtGui.QFont()
        font.setFamily("Digital-7")
        font.setPointSize(30)
        ...
        self.gridLayout_51.addWidget(self.txt_localtime, 2, 0, 1, 1)
        self.gridLayout.addWidget(self.LocalDateTime, 1, 1, 1, 1)
        self.SunRiseSet = QtWidgets.QGroupBox(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.SunRiseSet.setFont(font)
        self.SunRiseSet.setObjectName("SunRiseSet")
        self.gridLayout_52 = QtWidgets.QGridLayout(self.SunRiseSet)
        self.gridLayout_52.setObjectName("gridLayout_52")
        self.txt_sunel = QtWidgets.QLabel(self.SunRiseSet)
        font = QtGui.QFont()
        font.setFamily("Digital-7")
        font.setPointSize(30)
        self.txt_sunel.setFont(font)
        self.txt_sunel.setAlignment(QtCore.Qt.AlignCenter)
        self.txt_sunel.setObjectName("txt_sunel")
        self.gridLayout_52.addWidget(self.txt_sunel, 0, 0, 1, 1)
        self.txt_skystat = QtWidgets.QLabel(self.SunRiseSet)
        font = QtGui.QFont()
        font.setFamily("Digital-7")
        font.setPointSize(30)
        self.txt_skystat.setFont(font)
        self.txt_skystat.setAlignment(QtCore.Qt.AlignCenter)
        self.txt_skystat.setObjectName("txt_skystat")
        self.gridLayout_52.addWidget(self.txt_skystat, 2, 0, 1, 1)
        self.gridLayout.addWidget(self.SunRiseSet, 1, 3, 1, 1)
        self.MoonElPhase = QtWidgets.QGroupBox(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.MoonElPhase.setFont(font)
        self.MoonElPhase.setObjectName("MoonElPhase")
        self.gridLayout_53 = QtWidgets.QGridLayout(self.MoonElPhase)
        self.gridLayout_53.setObjectName("gridLayout_53")
        self.txt_moonel = QtWidgets.QLabel(self.MoonElPhase)
        font = QtGui.QFont()
        font.setFamily("Digital-7")
        font.setPointSize(30)
        self.txt_moonel.setFont(font)
        self.txt_moonel.setAlignment(QtCore.Qt.AlignCenter)
        self.txt_moonel.setObjectName("txt_moonel")
        self.gridLayout_53.addWidget(self.txt_moonel, 0, 0, 1, 1)
        self.txt_moonphase = QtWidgets.QLabel(self.MoonElPhase)
        font = QtGui.QFont()
        font.setFamily("Digital-7")
        font.setPointSize(30)
        self.txt_moonphase.setFont(font)
        self.txt_moonphase.setAlignment(QtCore.Qt.AlignCenter)
        self.txt_moonphase.setObjectName("txt_moonphase")
        self.gridLayout_53.addWidget(self.txt_moonphase, 2, 0, 1, 1)
        self.gridLayout.addWidget(self.MoonElPhase, 1, 4, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.datalog_editkeywords, 0, 5, 1, 1)
        self.datalog_cleartable = QtWidgets.QPushButton(self.widget_6)
        self.datalog_cleartable.setObjectName("datalog_cleartable")
        self.gridLayout_14.addWidget(self.datalog_cleartable, 0, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.UTCDateTime.setTitle(_translate("MainWindow", "Universal Time"))
        self.txt_utcdate.setText(_translate("MainWindow", "UTC"))
        self.txt_utc.setText(_translate("MainWindow", "LOCAL"))
        self.LocalDateTime.setTitle(_translate("MainWindow", "Local Time (MST)"))
        self.txt_localdate.setText(_translate("MainWindow", "UTC"))
        self.txt_localtime.setText(_translate("MainWindow", "LOCAL"))
        self.SunRiseSet.setTitle(_translate("MainWindow", "Sun Status"))
        self.txt_sunel.setText(_translate("MainWindow", "SUN ELEVATION"))
        self.txt_skystat.setText(_translate("MainWindow", "SKY STATUS"))
        self.MoonElPhase.setTitle(_translate("MainWindow", "Moon Status"))
        self.txt_moonel.setText(_translate("MainWindow", "ELEVATION"))
        self.txt_moonphase.setText(_translate("MainWindow", "PHASE"))
        ...
        self.datalog_cleartable.setText(_translate("MainWindow", "Clear Table"))
        ...
        self.datalog_instrumentselect.setItemText(3, _translate("MainWindow", "RIMAS"))
        self.datalog_instrumentselect.setItemText(4, _translate("MainWindow", "RC1"))
        self.datalog_instrumentselect.setItemText(5, _translate("MainWindow", "RC2"))
